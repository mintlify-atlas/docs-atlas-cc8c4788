...
description: "MindFlow dashboard returns active tasks by deadline, pending micro-objectives by task, and a 30-session fatigue history chart in a single API call."
---
