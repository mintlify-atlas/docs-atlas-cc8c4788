...
description: "When fatigue is high (score ≥ 4), the Task Decomposer calls an external LLM to break tasks into 2–7 micro-objectives of 25 minutes or less per task."
---
