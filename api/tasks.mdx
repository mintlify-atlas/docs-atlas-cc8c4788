---
title: "Tasks API: task and micro-objective CRUD endpoints"
sidebarTitle: "Tasks"
description: "Create, list, update, and soft-delete academic tasks. Manage AI-generated micro-objectives per task. All endpoints require a valid JWT Bearer token."
---
