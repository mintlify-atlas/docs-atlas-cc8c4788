...
description: "Start EMA sessions, submit fatigue scores (1–5), and fetch session history. Out-of-range scores are rejected by the DTO before any database write occurs."
---
