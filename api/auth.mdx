---
title: "Auth API: register and login endpoints"
sidebarTitle: "Auth"
description: "POST /api/v1/auth/register creates a student account. POST /api/v1/auth/login returns a 24-hour JWT. Both endpoints are public and require no authorization header."
---
